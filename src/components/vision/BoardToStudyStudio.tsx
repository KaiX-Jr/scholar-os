    ...
    <section id="vision" className="py-20 scroll-mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 h-[540px] lg:h-[640px]">
            <HighResImageViewer
                ...
                {activeBoardResult ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center p-8 border border-dashed border-white/10 rounded-2xl">
                    ...
                    <p className="text-xs text-slate-400 mt-1 max-w-sm leading-relaxed">
                      Upload or snap a classroom chalkboard photo on the left to generate structured notes, step-by-step logic, and active recall flashcards.
                    </p>
